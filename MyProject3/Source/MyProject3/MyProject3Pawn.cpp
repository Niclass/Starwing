...
void AMyProject3Pawn::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	...
	InputComponent->BindAxis("Thrust", this, &AMyProject3Pawn::ThrustInput);
	InputComponent->BindAxis("MoveUp", this, &AMyProject3Pawn::MoveUpInput);
	InputComponent->BindAxis("MoveRight", this, &AMyProject3Pawn::MoveRightInput);
}
